    ...
    def metric_specs(
        ...
        candidates = (
            ...
            cls.summary_spec(
                ...
                worse_when=worse,
                mode_key="p5_mode",
                current_key="metric_p5",
                cache_key_field="metric_p5_cache_key",
                label="P5",
                rule_id="p5-progressive",
            ),
            cls.summary_spec(
                options_extra,
                report_extra,
                worse_when=worse,
                mode_key="p10_mode",
                current_key="metric_p10",
                cache_key_field="metric_p10_cache_key",
                label="P10",
                rule_id="p10-progressive",
            ),
            cls.summary_spec(
                options_extra,
                report_extra,
