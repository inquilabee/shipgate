...
from refactor.rules.native.merges.extract_duplicate_method import ExtractDuplicateMethodRule
...
from refactor.rules.native.merges.remove_none_from_default_get import RemoveNoneFromDefaultGetRule
