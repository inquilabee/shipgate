...
from refactor.rules.native.extract.hoist_statement_from_if import HoistStatementFromIfRule
from refactor.rules.native.extract.merge_assign_and_aug_assign import MergeAssignAndAugAssignRule
...
from refactor.rules.native.extract.remove_unnecessary_cast import RemoveUnnecessaryCastRule
