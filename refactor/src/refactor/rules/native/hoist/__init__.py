...
from refactor.rules.native.hoist.class_method_first_arg_name import ClassMethodFirstArgNameRule
...
from refactor.rules.native.hoist.simplify_substring_search import SimplifySubstringSearchRule
